...
(function(f) {
  ...
  return function e(t, n, r) {
    ...
    tinf_build_fixed_trees(sltree, sdtree), tinf_build_bits_base(length_bits, length_base, 4, 3), tinf_build_bits_base(dist_bits, dist_base, 2, 1), length_bits[28] = 0, length_base[28] = 258, module3.exports = tinf_uncompress;
  }, {}], 2: [function(require2, module3, exports3) {
    "use strict";
    exports3.fail = function(r) {
      throw new Error(r);
    }, exports3.argument = function(r, t) {
      r || exports3.fail(t);
      ...
      switch (e.version) {
        ...
        case 2:
          for (this.names = new Array(e.numberOfGlyphs), l = 0; l < e.numberOfGlyphs; l++)
            this.names[l] = e.glyphNameIndex[l] < exports3.standardNames.length ? exports3.standardNames[e.glyphNameIndex[l]] : e.names[e.glyphNameIndex[l] - exports3.standardNames.length];
          break;
        case 2.5:
          for (this.names = new Array(e.numberOfGlyphs), l = 0; l < e.numberOfGlyphs; l++)
            this.names[l] = exports3.standardNames[l + e.glyphNameIndex[l]];
          break;
        case 3:
          this.names = [];
      }
    ...
    DefaultEncoding.prototype.charToGlyphIndex = function(e) {
      ...
      return this.names[e];
    }, exports3.cffStandardStrings = cffStandardStrings, exports3.cffStandardEncoding = cffStandardEncoding, exports3.cffExpertEncoding = cffExpertEncoding, exports3.standardNames = standardNames, exports3.DefaultEncoding = DefaultEncoding, exports3.CmapEncoding = CmapEncoding, exports3.CffEncoding = CffEncoding, exports3.GlyphNames = GlyphNames, exports3.addGlyphNames = addGlyphNames;
  }, {}], 5: [function(require2, module3, exports3) {
    "use strict";
    function Font(e) {
      e = e || {}, e.empty || (util.checkArgument(e.familyName, "When creating a new Font object, familyName is required."), util.checkArgument(e.styleName, "When creating a new Font object, styleName is required."), util.checkArgument(e.unitsPerEm, "When creating a new Font object, unitsPerEm is required."), util.checkArgument(e.ascender, "When creating a new Font object, ascender is required."), util.checkArgument(e.descender, "When creating a new Font object, descender is required."), util.checkArgument(e.descender < 0, "Descender should be negative (e.g. -512)."), this.names = { fontFamily: { en: e.familyName || " " }, fontSubfamily: { en: e.styleName || " " }, fullName: { en: e.fullName || e.familyName + " " + e.styleName }, postScriptName: { en: e.postScriptName || e.familyName + e.styleName }, designer: { en: e.designer || " " }, designerURL: { en: e.designerURL || " " }, manufacturer: { en: e.manufacturer || " " }, manufacturerURL: { en: e.manufacturerURL || " " }, license: { en: e.license || " " }, licenseURL: { en: e.licenseURL || " " }, version: { en: e.version || "Version 0.1" }, description: { en: e.description || " " }, copyright: { en: e.copyright || " " }, trademark: { en: e.trademark || " " } }, this.unitsPerEm = e.unitsPerEm || 1e3, this.ascender = e.ascender, this.descender = e.descender, this.createdTimestamp = e.createdTimestamp, this.tables = { os2: { usWeightClass: e.weightClass || this.usWeightClasses.MEDIUM, usWidthClass: e.widthClass || this.usWidthClasses.MEDIUM, fsSelection: e.fsSelection || this.fsSelectionValues.REGULAR } }), this.supported = true, this.glyphs = new glyphset.GlyphSet(this, e.glyphs || []), this.encoding = new encoding.DefaultEncoding(this), this.substitution = new Substitution(this), this.tables = this.tables || {};
    }
    var path = require2("./path"), sfnt = require2("./tables/sfnt"), encoding = require2("./encoding"), glyphset = require2("./glyphset"), Substitution = require2("./substitution"), util = require2("./util");
    Font.prototype.hasChar = function(e) {
      ...
      for (var s = void 0 === r.kerning ? true : r.kerning, a = 1 / this.unitsPerEm * i, h = this.stringToGlyphs(e), u = 0; u < h.length; u += 1) {
        var c = h[u];
      ...
      var o = new path.Path();
      return this.forEachGlyph(e, t, n, i, r, function(e2, t2, n2, i2) {
        var r2 = e2.getPath(t2, n2, i2);
        o.extend(r2);
      }), o;
      ...
      this.forEachGlyph(t, n, i, r, o, function(t2, n2, i2, r2) {
        t2.drawPoints(e, n2, i2, r2);
      });
    }, Font.prototype.drawMetrics = function(e, t, n, i, r, o) {
      this.forEachGlyph(t, n, i, r, o, function(t2, n2, i2, r2) {
        t2.drawMetrics(e, n2, i2, r2);
      });
      ...
      function t(t2) {
        var n2 = i.getEnglishName(t2);
        e(n2 && n2.trim().length > 0, "No English " + t2 + " specified.");
      }
      var n = [], i = this;
      ...
      var e = this.getEnglishName("fontFamily"), t = this.getEnglishName("fontSubfamily"), n = e.replace(/\s/g, "") + "-" + t + ".otf", i = this.toArrayBuffer();
      if (util.isBrowser())
        window.requestFileSystem = window.requestFileSystem || window.webkitRequestFileSystem, window.requestFileSystem(window.TEMPORARY, i.byteLength, function(e2) {
          e2.root.getFile(n, { create: true }, function(e3) {
            e3.createWriter(function(t2) {
              var n2 = new DataView(i), r2 = new Blob([n2], { type: "font/opentype" });
              t2.write(r2), t2.addEventListener("writeend", function() {
                location.href = e3.toURL();
              }, false);
            });
          });
        }, function(e2) {
          throw new Error(e2.name + ": " + e2.message);
        });
      else {
        var r = require2("fs"), o = util.arrayBufferToNodeBuffer(i);
        r.writeFileSync(n, o);
      }
    }, Font.prototype.fsSelectionValues = { ITALIC: 1, UNDERSCORE: 2, NEGATIVE: 4, OUTLINED: 8, STRIKEOUT: 16, BOLD: 32, REGULAR: 64, USER_TYPO_METRICS: 128, WWS: 256, OBLIQUE: 512 }, Font.prototype.usWidthClasses = { ULTRA_CONDENSED: 1, EXTRA_CONDENSED: 2, CONDENSED: 3, SEMI_CONDENSED: 4, MEDIUM: 5, SEMI_EXPANDED: 6, EXPANDED: 7, EXTRA_EXPANDED: 8, ULTRA_EXPANDED: 9 }, Font.prototype.usWeightClasses = { THIN: 100, EXTRA_LIGHT: 200, LIGHT: 300, NORMAL: 400, MEDIUM: 500, SEMI_BOLD: 600, BOLD: 700, EXTRA_BOLD: 800, BLACK: 900 }, exports3.Font = Font;
  }, { "./encoding": 4, "./glyphset": 7, "./path": 11, "./substitution": 12, "./tables/sfnt": 31, "./util": 33, "fs": void 0 }], 6: [function(require2, module3, exports3) {
    "use strict";
    ...
    var check = require2("./check"), draw = require2("./draw"), path = require2("./path");
    Glyph.prototype.bindConstructorValues = function(t) {
      ...
      t = void 0 !== t ? t : 0, i = void 0 !== i ? i : 0, n = void 0 !== n ? n : { xScale: 1, yScale: 1 }, e = void 0 !== e ? e : 72;
      ...
      var h = { xMin: Math.min.apply(null, i), yMin: Math.min.apply(null, e), xMax: Math.max.apply(null, i), yMax: Math.max.apply(null, e), leftSideBearing: this.leftSideBearing };
      ...
      function a(i2, e2, n2, a2) {
        var h2 = 2 * Math.PI;
        t.beginPath();
        for (var o2 = 0; o2 < i2.length; o2 += 1)
          t.moveTo(e2 + i2[o2].x * a2, n2 + i2[o2].y * a2), t.arc(e2 + i2[o2].x * a2, n2 + i2[o2].y * a2, 2, 0, h2, false);
        t.closePath(), t.fill();
      }
      ...
      var h = this.xMin || 0, o = this.yMin || 0, r = this.xMax || 0, s = this.yMax || 0, p = this.advanceWidth || 0;
  ...
  }, { "./check": 2, "./draw": 3, "./path": 11 }], 7: [function(require2, module3, exports3) {
    "use strict";
    ...
    function ttfGlyphLoader(e, t, n, r, p, h) {
      return function() {
        ...
        return i.path = function() {
          n(i, r, p);
          var t2 = h(e.glyphs, i);
          return t2.unitsPerEm = e.unitsPerEm, t2;
    ...
    }, exports3.GlyphSet = GlyphSet, exports3.glyphLoader = glyphLoader, exports3.ttfGlyphLoader = ttfGlyphLoader, exports3.cffGlyphLoader = cffGlyphLoader;
  }, { "./glyph": 6 }], 8: [function(require2, module3, exports3) {
    "use strict";
    ...
    var check = require2("./check"), Layout = { searchTag, binSearch, getScriptNames: function() {
      var e = this.getGsubTable();
      return e ? e.scripts.map(function(e2) {
        return e2.tag;
      }) : [];
  ...
  }, { "./check": 2 }], 9: [function(require2, module3, exports3) {
    "use strict";
    function loadFromFile(e, a) {
      var r = require2("fs");
      r.readFile(e, function(e2, r2) {
        return e2 ? a(e2.message) : void a(null, util.nodeBufferToArrayBuffer(r2));
      });
    }
    function loadFromUrl(e, a) {
      var r = new XMLHttpRequest();
      r.open("get", e, true), r.responseType = "arraybuffer", r.onload = function() {
    ...
    function parseOpenTypeTableEntries(e, a) {
      for (var r = [], s = 12, t = 0; a > t; t += 1) {
        ...
        r.push({ tag: n, checksum: o, offset: p, length: l, compression: false }), s += 16;
      }
      return r;
    }
    function parseWOFFTableEntries(e, a) {
      for (var r = [], s = 44, t = 0; a > t; t += 1) {
        ...
        n = f > l ? "WOFF" : false, r.push({ tag: o, offset: p, compression: n, compressedLength: l, originalLength: f }), s += 20;
      }
      return r;
    }
    ...
    function parseBuffer(e) {
      var a, r, s, t = new _font.Font({ empty: true }), n = new DataView(e, 0), o = [], p = parse.getTag(n, 0);
    ...
    function load(e, a) {
      var r = "undefined" == typeof window, s = r ? loadFromFile : loadFromUrl;
      s(e, function(e2, r2) {
        if (e2)
          return a(e2);
        var s2;
    ...
    function loadSync(e) {
      var a = require2("fs"), r = a.readFileSync(e);
      return parseBuffer(util.nodeBufferToArrayBuffer(r));
    }
    var inflate = require2("tiny-inflate"), encoding = require2("./encoding"), _font = require2("./font"), glyph = require2("./glyph"), parse = require2("./parse"), path = require2("./path"), util = require2("./util"), cmap = require2("./tables/cmap"), cff = require2("./tables/cff"), fvar = require2("./tables/fvar"), glyf = require2("./tables/glyf"), gpos = require2("./tables/gpos"), gsub = require2("./tables/gsub"), head = require2("./tables/head"), hhea = require2("./tables/hhea"), hmtx = require2("./tables/hmtx"), kern = require2("./tables/kern"), ltag = require2("./tables/ltag"), loca = require2("./tables/loca"), maxp = require2("./tables/maxp"), _name = require2("./tables/name"), os2 = require2("./tables/os2"), post = require2("./tables/post"), meta = require2("./tables/meta");
    exports3._parse = parse, exports3.Font = _font.Font, exports3.Glyph = glyph.Glyph, exports3.Path = path.Path, exports3.parse = parseBuffer, exports3.load = load, exports3.loadSync = loadSync;
  }, { "./encoding": 4, "./font": 5, "./glyph": 6, "./parse": 10, "./path": 11, "./tables/cff": 14, "./tables/cmap": 15, "./tables/fvar": 16, "./tables/glyf": 17, "./tables/gpos": 18, "./tables/gsub": 19, "./tables/head": 20, "./tables/hhea": 21, "./tables/hmtx": 22, "./tables/kern": 23, "./tables/loca": 24, "./tables/ltag": 25, "./tables/maxp": 26, "./tables/meta": 27, "./tables/name": 28, "./tables/os2": 29, "./tables/post": 30, "./util": 33, "fs": void 0, "tiny-inflate": 1 }], 10: [function(require2, module3, exports3) {
    "use strict";
    function getUShort(t, r) {
      return t.getUint16(r, false);
    }
    function Parser(t, r) {
      this.data = t, this.offset = r, this.relativeOffset = 0;
    }
    var check = require2("./check");
    exports3.getByte = function(t, r) {
      return t.getUint8(r);
    }, exports3.getCard8 = exports3.getByte, exports3.getUShort = exports3.getCard16 = getUShort, exports3.getShort = function(t, r) {
      return t.getInt16(r, false);
    }, exports3.getULong = function(t, r) {
      return t.getUint32(r, false);
    }, exports3.getFixed = function(t, r) {
      var e = t.getInt16(r, false), s = t.getUint16(r + 2, false);
      return e + s / 65535;
    }, exports3.getTag = function(t, r) {
      for (var e = "", s = r; r + 4 > s; s += 1)
        e += String.fromCharCode(t.getInt8(s));
      return e;
    }, exports3.getOffset = function(t, r, e) {
      for (var s = 0, a = 0; e > a; a += 1)
        s <<= 8, s += t.getUint8(r + a);
      return s;
    }, exports3.getBytes = function(t, r, e) {
      for (var s = [], a = r; e > a; a += 1)
        s.push(t.getUint8(a));
      return s;
    }, exports3.bytesToString = function(t) {
    ...
    Parser.prototype.parseByte = function() {
      ...
      var t = exports3.getULong(this.data, this.offset + this.relativeOffset);
      return this.relativeOffset += 4, t;
    }, Parser.prototype.parseFixed = function() {
      var t = exports3.getFixed(this.data, this.offset + this.relativeOffset);
      return this.relativeOffset += 4, t;
      ...
      var t = exports3.getULong(this.data, this.offset + this.relativeOffset + 4);
      return t -= 2082844800, this.relativeOffset += 8, t;
    }, Parser.prototype.parseVersion = function() {
      var t = getUShort(this.data, this.offset + this.relativeOffset), r = getUShort(this.data, this.offset + this.relativeOffset + 2);
      ...
      var t = this.offset + this.relativeOffset, r = this.parseUShort(), e = this.parseUShort();
      if (1 === r)
      ...
      check.assert(false, "0x" + t.toString(16) + ": Coverage format must be 1 or 2.");
    }, Parser.prototype.parseClassDef = function() {
      var t = this.offset + this.relativeOffset, r = this.parseUShort();
      return 1 === r ? { format: 1, startGlyph: this.parseUShort(), classes: this.parseUShortList() } : 2 === r ? { format: 2, ranges: this.parseRecordList({ start: Parser.uShort, end: Parser.uShort, classId: Parser.uShort }) } : void check.assert(false, "0x" + t.toString(16) + ": ClassDef format must be 1 or 2.");
    ...
    Parser.prototype.parseScriptList = function() {
      ...
      return this.parsePointer(Parser.list(Parser.pointer(function() {
        ...
        return { lookupType: r, lookupFlag: e, subtables: this.parseList(Parser.pointer(t[r])), markFilteringSet: s ? this.parseUShort() : void 0 };
      })));
    }, exports3.Parser = Parser;
  }, { "./check": 2 }], 11: [function(require2, module3, exports3) {
    "use strict";
    function Path() {
    ...
    Path.prototype.moveTo = function(t, o) {
      ...
      function o(o2) {
        return Math.round(o2) === o2 ? "" + Math.round(o2) : o2.toFixed(t);
      }
      function e() {
        for (var t2 = "", e2 = 0; e2 < arguments.length; e2 += 1) {
          var i2 = arguments[e2];
          i2 >= 0 && e2 > 0 && (t2 += " "), t2 += o(i2);
        }
        return t2;
      }
      t = void 0 !== t ? t : 2;
    ...
    var check = require2("./check"), Layout = require2("./layout"), Substitution = function(t) {
      this.font = t;
    };
    Substitution.prototype = Layout, Substitution.prototype.getGsubTable = function(t) {
      var e = this.font.tables.gsub;
      return !e && t && (this.font.tables.gsub = e = { version: 1, scripts: [{ tag: "DFLT", script: { defaultLangSys: { reserved: 0, reqFeatureIndex: 65535, featureIndexes: [] }, langSysRecords: [] } }], features: [], lookups: [] }), e;
      ...
      var s = this.getLookupTable(r, a, t, 1, true), o = getSubstFormat(s, 2, { substFormat: 2, coverage: { format: 1, glyphs: [] }, substitute: [] });
      ...
      var s = this.getLookupTable(r, a, t, 3, true), o = getSubstFormat(s, 1, { substFormat: 1, coverage: { format: 1, glyphs: [] }, alternateSets: [] });
      check.assert(1 === o.coverage.format, "Ligature: unable to modify coverage table format " + o.coverage.format);
      var u = e.sub, i = this.binSearch(o.coverage.glyphs, u);
      ...
      r = r || "DFLT", a = a || "DFLT";
      var s = this.getLookupTable(r, a, t, 4, true), o = s.subtables[0];
      o || (o = { substFormat: 1, coverage: { format: 1, glyphs: [] }, ligatureSets: [] }, s.subtables[0] = o), check.assert(1 === o.coverage.format, "Ligature: unable to modify coverage table format " + o.coverage.format);
      var u = e.sub[0], i = e.sub.slice(1), n = { ligGlyph: e.by, components: i }, g = this.binSearch(o.coverage.glyphs, u);
      if (g >= 0) {
    ...
    }, module3.exports = Substitution;
  }, { "./check": 2, "./layout": 8 }], 13: [function(require2, module3, exports3) {
    "use strict";
    ...
    function Coverage(e) {
      1 === e.format ? Table.call(this, "coverageTable", [{ name: "coverageFormat", type: "USHORT", value: 1 }].concat(ushortList("glyph", e.glyphs))) : check.assert(false, "Can't create coverage table format 2 yet.");
    }
    function ScriptList(e) {
      Table.call(this, "scriptListTable", recordList("scriptRecord", e, function(e2, t) {
        var a = e2.script, r = a.defaultLangSys;
        return check.assert(!!r, "Unable to write GSUB: script " + e2.tag + " has no default language system."), [{ name: "scriptTag" + t, type: "TAG", value: e2.tag }, { name: "script" + t, type: "TABLE", value: new Table("scriptTable", [{ name: "defaultLangSys", type: "TABLE", value: new Table("defaultLangSys", [{ name: "lookupOrder", type: "USHORT", value: 0 }, { name: "reqFeatureIndex", type: "USHORT", value: r.reqFeatureIndex }].concat(ushortList("featureIndex", r.featureIndexes))) }].concat(recordList("langSys", a.langSysRecords, function(e3, t2) {
          var a2 = e3.langSys;
          return [{ name: "langSysTag" + t2, type: "TAG", value: e3.tag }, { name: "langSys" + t2, type: "TABLE", value: new Table("langSys", [{ name: "lookupOrder", type: "USHORT", value: 0 }, { name: "reqFeatureIndex", type: "USHORT", value: a2.reqFeatureIndex }].concat(ushortList("featureIndex", a2.featureIndexes))) }];
        }))) }];
      }));
    }
    function FeatureList(e) {
      Table.call(this, "featureListTable", recordList("featureRecord", e, function(e2, t) {
        var a = e2.feature;
        return [{ name: "featureTag" + t, type: "TAG", value: e2.tag }, { name: "feature" + t, type: "TABLE", value: new Table("featureTable", [{ name: "featureParams", type: "USHORT", value: a.featureParams }].concat(ushortList("lookupListIndex", a.lookupListIndexes))) }];
      }));
    }
    function LookupList(e, t) {
      Table.call(this, "lookupListTable", tableList("lookup", e, function(e2) {
        var a = t[e2.lookupType];
        return check.assert(!!a, "Unable to write GSUB lookup type " + e2.lookupType + " tables."), new Table("lookupTable", [{ name: "lookupType", type: "USHORT", value: e2.lookupType }, { name: "lookupFlag", type: "USHORT", value: e2.lookupFlag }].concat(tableList("subtable", e2.subtables, a)));
      }));
    }
    var check = require2("./check"), encode = require2("./types").encode, sizeOf = require2("./types").sizeOf;
    Table.prototype.encode = function() {
      return encode.TABLE(this);
    }, Table.prototype.sizeOf = function() {
      return sizeOf.TABLE(this);
    }, Coverage.prototype = Object.create(Table.prototype), Coverage.prototype.constructor = Coverage, ScriptList.prototype = Object.create(Table.prototype), ScriptList.prototype.constructor = ScriptList, FeatureList.prototype = Object.create(Table.prototype), FeatureList.prototype.constructor = FeatureList, LookupList.prototype = Object.create(Table.prototype), LookupList.prototype.constructor = LookupList, exports3.Record = exports3.Table = Table, exports3.Coverage = Coverage, exports3.ScriptList = ScriptList, exports3.FeatureList = FeatureList, exports3.LookupList = LookupList, exports3.ushortList = ushortList, exports3.tableList = tableList, exports3.recordList = recordList;
  }, { "./check": 2, "./types": 32 }], 14: [function(require2, module3, exports3) {
    "use strict";
    function equals(e, t) {
      if (e === t)
        return true;
    ...
    function parseCFFCharstring(e, t, a) {
      function r(e2, t2) {
        g && p.closePath(), p.moveTo(e2, t2), g = true;
      }
      function n() {
        var t2;
        t2 = u.length % 2 !== 0, t2 && !c && (d = u.shift() + e.nominalWidthX), l += u.length >> 1, u.length = 0, c = true;
      }
      function s(a2) {
        for (var y, b, C, T, F, I, D, x, k, S, E, O, R = 0; R < a2.length; ) {
          var M = a2[R];
          switch (R += 1, M) {
            case 1:
              n();
            ...
            case 3:
              ...
              break;
            case 4:
              u.length > 1 && !c && (d = u.shift() + e.nominalWidthX, c = true), m += u.pop(), r(v, m);
              break;
            case 5:
              for (; u.length > 0; )
            ...
            case 12:
              ...
              break;
            case 14:
              u.length > 0 && !c && (d = u.shift() + e.nominalWidthX, c = true), g && (p.closePath(), g = false);
              break;
            case 18:
              n();
              break;
            ...
            case 20:
              ...
              break;
            case 21:
              u.length > 2 && !c && (d = u.shift() + e.nominalWidthX, c = true), m += u.pop(), v += u.pop(), r(v, m);
              break;
            case 22:
              u.length > 1 && !c && (d = u.shift() + e.nominalWidthX, c = true), v += u.pop(), r(v, m);
              break;
            case 23:
              n();
              break;
            ...
            case 27:
              ...
              break;
            case 28:
              y = a2[R], b = a2[R + 1], u.push((y << 24 | b << 16) >> 16), R += 2;
              break;
            case 29:
            ...
            case 31:
              ...
              break;
            default:
              32 > M ? console.log("Glyph " + t.index + ": unknown operator " + M) : 247 > M ? u.push(M - 139) : 251 > M ? (y = a2[R], R += 1, u.push(256 * (M - 247) + y + 108)) : 255 > M ? (y = a2[R], R += 1, u.push(256 * -(M - 251) - y - 108)) : (y = a2[R], b = a2[R + 1], C = a2[R + 2], T = a2[R + 3], R += 4, u.push((y << 24 | b << 16 | C << 8 | T) / 65536));
          }
        }
      }
      var i, o, h, f, p = new path.Path(), u = [], l = 0, c = false, d = e.defaultWidthX, g = false, v = 0, m = 0;
    ...
    function parseCFFTable(e, t, a) {
      a.tables.cff = {};
      var r = parseCFFHeader(e, t), n = parseCFFIndex(e, r.endOffset, parse.bytesToString), s = parseCFFIndex(e, n.endOffset), i = parseCFFIndex(e, s.endOffset, parse.bytesToString), o = parseCFFIndex(e, i.endOffset);
      a.gsubrs = o.objects, a.gsubrsBias = calcCFFSubroutineBias(a.gsubrs);
      var h = new DataView(new Uint8Array(s.objects[0]).buffer), f = parseCFFTopDict(h, i.objects);
      a.tables.cff.topDict = f;
      var p = t + f["private"][1], u = parseCFFPrivateDict(e, p, f["private"][0], i.objects);
    ...
    function parseCmapTableFormat4(e, a, r, t, n) {
      ...
      var l = new parse.Parser(r, t + n + 14), p = new parse.Parser(r, t + n + 16 + 2 * o), g = new parse.Parser(r, t + n + 16 + 4 * o), m = new parse.Parser(r, t + n + 16 + 6 * o), u = t + n + 16 + 8 * o;
      for (s = 0; o - 1 > s; s += 1)
    ...
    function makeCmapTable(e) {
      ...
      for (r.segments = [], a = 0; a < e.length; a += 1) {
        ...
        r.segments = r.segments.sort(function(e2, a2) {
          return e2.start - a2.start;
        });
      }
    ...
    var check = require2("../check"), parse = require2("../parse"), table = require2("../table");
    exports3.parse = parseCmapTable, exports3.make = makeCmapTable;
  }, { "../check": 2, "../parse": 10, "../table": 13 }], 16: [function(require2, module3, exports3) {
    "use strict";
    ...
    function makeFvarAxis(e, a, r) {
      ...
      return [{ name: "tag_" + e, type: "TAG", value: a.tag }, { name: "minValue_" + e, type: "FIXED", value: a.minValue << 16 }, { name: "defaultValue_" + e, type: "FIXED", value: a.defaultValue << 16 }, { name: "maxValue_" + e, type: "FIXED", value: a.maxValue << 16 }, { name: "flags_" + e, type: "USHORT", value: 0 }, { name: "nameID_" + e, type: "USHORT", value: n }];
    }
    ...
    var check = require2("../check"), parse = require2("../parse"), table = require2("../table");
    exports3.make = makeFvarTable, exports3.parse = parseFvarTable;
  }, { "../check": 2, "../parse": 10, "../table": 13 }], 17: [function(require2, module3, exports3) {
    "use strict";
    ...
    function getPath(e) {
      ...
      for (var t = getContours(e), o = 0; o < t.length; o += 1) {
        ...
        p.onCurve ? (a = null, n = true) : (p = i.onCurve ? i : { x: (p.x + i.x) / 2, y: (p.y + i.y) / 2 }, a = p, n = false), r.moveTo(p.x, p.y);
    ...
    var check = require2("../check"), glyphset = require2("../glyphset"), parse = require2("../parse"), path = require2("../path");
    exports3.parse = parseGlyfTable;
  }, { "../check": 2, "../glyphset": 7, "../parse": 10, "../path": 11 }], 18: [function(require2, module3, exports3) {
    "use strict";
    ...
    function parseCoverageTable(r, e) {
      var a = new parse.Parser(r, e), s = a.parseUShort(), t = a.parseUShort();
      if (1 === s)
    ...
    function parseClassDefTable(r, e) {
      ...
      if (2 === s) {
        ...
        return function(r2) {
          for (var e2 = 0, a2 = f.length - 1; a2 > e2; ) {
            var s2 = e2 + a2 + 1 >> 1;
            r2 < f[s2] ? a2 = s2 - 1 : e2 = s2;
          }
          return f[e2] <= r2 && r2 <= i[e2] ? h[e2] || 0 : 0;
        };
      }
    }
    function parsePairPosSubTable(r, e) {
      var a, s, t = new parse.Parser(r, e), o = t.parseUShort(), p = t.parseUShort(), n = parseCoverageTable(r, e + p), f = t.parseUShort(), i = t.parseUShort();
      if (4 === f && 0 === i) {
        var h = {};
        if (1 === o) {
        ...
        if (2 === o) {
          ...
          return function(r2, e2) {
            if (V[r2]) {
              var a2 = d(r2), s2 = w(e2), t2 = O[a2];
              return t2 ? t2[s2] : void 0;
            }
          };
        }
      }
    ...
    function parseLookupTable(r, e) {
      var a = new parse.Parser(r, e), s = a.parseUShort(), t = a.parseUShort(), o = 16 & t, p = a.parseUShort(), n = a.parseOffset16List(p), f = { lookupType: s, lookupFlag: t, markFilteringSet: o ? a.parseUShort() : -1 };
      if (2 === s) {
        for (var i = [], h = 0; p > h; h++)
          i.push(parsePairPosSubTable(r, e + n[h]));
        f.getKerningValue = function(r2, e2) {
          for (var a2 = i.length; a2--; ) {
            var s2 = i[a2](r2, e2);
            if (void 0 !== s2)
              return s2;
          }
    ...
    var check = require2("../check"), parse = require2("../parse");
    exports3.parse = parseGposTable;
  }, { "../check": 2, "../parse": 10 }], 19: [function(require2, module3, exports3) {
    "use strict";
    function parseGsubTable(e, t) {
      t = t || 0;
      var s = new Parser(e, t), r = s.parseVersion();
      return check.argument(1 === r, "Unsupported GSUB table version."), { version: r, scripts: s.parseScriptList(), features: s.parseFeatureList(), lookups: s.parseLookupList(subtableParsers) };
    }
    ...
    var check = require2("../check"), Parser = require2("../parse").Parser, subtableParsers = new Array(9), table = require2("../table");
    subtableParsers[1] = function() {
      var e = this.offset + this.relativeOffset, t = this.parseUShort();
      return 1 === t ? { substFormat: 1, coverage: this.parsePointer(Parser.coverage), deltaGlyphId: this.parseUShort() } : 2 === t ? { substFormat: 2, coverage: this.parsePointer(Parser.coverage), substitute: this.parseOffset16List() } : void check.assert(false, "0x" + e.toString(16) + ": lookup type 1 format must be 1 or 2.");
    }, subtableParsers[2] = function() {
      var e = this.parseUShort();
      return check.argument(1 === e, "GSUB Multiple Substitution Subtable identifier-format must be 1"), { substFormat: e, coverage: this.parsePointer(Parser.coverage), sequences: this.parseListOfLists() };
    }, subtableParsers[3] = function() {
      var e = this.parseUShort();
      return check.argument(1 === e, "GSUB Alternate Substitution Subtable identifier-format must be 1"), { substFormat: e, coverage: this.parsePointer(Parser.coverage), alternateSets: this.parseListOfLists() };
    }, subtableParsers[4] = function() {
      var e = this.parseUShort();
      return check.argument(1 === e, "GSUB ligature table identifier-format must be 1"), { substFormat: e, coverage: this.parsePointer(Parser.coverage), ligatureSets: this.parseListOfLists(function() {
    ...
    subtableParsers[5] = function() {
      ...
      if (1 === t)
        return { substFormat: t, coverage: this.parsePointer(Parser.coverage), ruleSets: this.parseListOfLists(function() {
          ...
          return { input: this.parseUShortList(e2 - 1), lookupRecords: this.parseRecordList(t2, lookupRecordDesc) };
        }) };
      if (2 === t)
        return { substFormat: t, coverage: this.parsePointer(Parser.coverage), classDef: this.parsePointer(Parser.classDef), classSets: this.parseListOfLists(function() {
          var e2 = this.parseUShort(), t2 = this.parseUShort();
          return { classes: this.parseUShortList(e2 - 1), lookupRecords: this.parseRecordList(t2, lookupRecordDesc) };
        }) };
      if (3 === t) {
      ...
      check.assert(false, "0x" + e.toString(16) + ": lookup type 5 format must be 1, 2 or 3.");
    }, subtableParsers[6] = function() {
      var e = this.offset + this.relativeOffset, t = this.parseUShort();
      return 1 === t ? { substFormat: 1, coverage: this.parsePointer(Parser.coverage), chainRuleSets: this.parseListOfLists(function() {
        ...
        return { backtrack: this.parseUShortList(), input: this.parseUShortList(this.parseShort() - 1), lookahead: this.parseUShortList(), lookupRecords: this.parseRecordList(lookupRecordDesc) };
      }) } : 3 === t ? { substFormat: 3, backtrackCoverage: this.parseList(Parser.pointer(Parser.coverage)), inputCoverage: this.parseList(Parser.pointer(Parser.coverage)), lookaheadCoverage: this.parseList(Parser.pointer(Parser.coverage)), lookupRecords: this.parseRecordList(lookupRecordDesc) } : void check.assert(false, "0x" + e.toString(16) + ": lookup type 6 format must be 1, 2 or 3.");
    }, subtableParsers[7] = function() {
      var e = this.parseUShort();
      check.argument(1 === e, "GSUB Extension Substitution subtable identifier-format must be 1");
      var t = this.parseUShort(), s = new Parser(this.data, this.offset + this.parseULong());
      return { substFormat: 1, lookupType: t, extension: subtableParsers[t].call(s) };
    }, subtableParsers[8] = function() {
      var e = this.parseUShort();
      return check.argument(1 === e, "GSUB Reverse Chaining Contextual Single Substitution Subtable identifier-format must be 1"), { substFormat: e, coverage: this.parsePointer(Parser.coverage), backtrackCoverage: this.parseList(Parser.pointer(Parser.coverage)), lookaheadCoverage: this.parseList(Parser.pointer(Parser.coverage)), substitutes: this.parseUShortList() };
    };
    ...
    subtableMakers[1] = function(e) {
      ...
      return check.assert(1 === e.substFormat, "Lookup type 3 substFormat must be 1."), new table.Table("substitutionTable", [{ name: "substFormat", type: "USHORT", value: 1 }, { name: "coverage", type: "TABLE", value: new table.Coverage(e.coverage) }].concat(table.tableList("altSet", e.alternateSets, function(e2) {
        return new table.Table("alternateSetTable", table.ushortList("alternate", e2));
      })));
    }, subtableMakers[4] = function(e) {
      return check.assert(1 === e.substFormat, "Lookup type 4 substFormat must be 1."), new table.Table("substitutionTable", [{ name: "substFormat", type: "USHORT", value: 1 }, { name: "coverage", type: "TABLE", value: new table.Coverage(e.coverage) }].concat(table.tableList("ligSet", e.ligatureSets, function(e2) {
        return new table.Table("ligatureSetTable", table.tableList("ligature", e2, function(e3) {
          return new table.Table("ligatureTable", [{ name: "ligGlyph", type: "USHORT", value: e3.ligGlyph }].concat(table.ushortList("component", e3.components, e3.components.length + 1)));
        }));
      })));
    }, exports3.parse = parseGsubTable, exports3.make = makeGsubTable;
  }, { "../check": 2, "../parse": 10, "../table": 13 }], 20: [function(require2, module3, exports3) {
    "use strict";
    ...
    var parse = require2("../parse"), table = require2("../table");
    exports3.parse = parseHheaTable, exports3.make = makeHheaTable;
  }, { "../parse": 10, "../table": 13 }], 22: [function(require2, module3, exports3) {
    "use strict";
    ...
    var parse = require2("../parse"), table = require2("../table");
    exports3.parse = parseHmtxTable, exports3.make = makeHmtxTable;
  }, { "../parse": 10, "../table": 13 }], 23: [function(require2, module3, exports3) {
    "use strict";
    ...
    var check = require2("../check"), parse = require2("../parse");
    exports3.parse = parseKernTable;
  }, { "../check": 2, "../parse": 10 }], 24: [function(require2, module3, exports3) {
    "use strict";
    ...
    exports3.parse = parseLocaTable;
  }, { "../parse": 10 }], 25: [function(require2, module3, exports3) {
    "use strict";
    ...
    var check = require2("../check"), parse = require2("../parse"), table = require2("../table");
    exports3.make = makeLtagTable, exports3.parse = parseLtagTable;
  }, { "../check": 2, "../parse": 10, "../table": 13 }], 26: [function(require2, module3, exports3) {
    "use strict";
    ...
    var parse = require2("../parse"), table = require2("../table");
    exports3.parse = parseMaxpTable, exports3.make = makeMaxpTable;
  }, { "../parse": 10, "../table": 13 }], 27: [function(require2, module3, exports3) {
    "use strict";
    ...
    function makeMetaTable(e) {
      var a = Object.keys(e).length, r = "", t = 16 + 12 * a, s = new table.Table("meta", [{ name: "version", type: "ULONG", value: 1 }, { name: "flags", type: "ULONG", value: 0 }, { name: "offset", type: "ULONG", value: t }, { name: "numTags", type: "ULONG", value: a }]);
      for (var n in e) {
        var p = r.length;
    ...
    var types = require2("../types"), decode = types.decode, check = require2("../check"), parse = require2("../parse"), table = require2("../table");
    exports3.parse = parseMetaTable, exports3.make = makeMetaTable;
  }, { "../check": 2, "../parse": 10, "../table": 13, "../types": 32 }], 28: [function(require2, module3, exports3) {
    "use strict";
    ...
    var encoding = require2("../encoding"), parse = require2("../parse"), table = require2("../table");
    exports3.parse = parsePostTable, exports3.make = makePostTable;
  }, { "../encoding": 4, "../parse": 10, "../table": 13 }], 31: [function(require2, module3, exports3) {
    "use strict";
    function log2(e) {
    ...
    function makeSfntTable(e) {
      var a = new table.Table("sfnt", [{ name: "version", type: "TAG", value: "OTTO" }, { name: "numTables", type: "USHORT", value: 0 }, { name: "searchRange", type: "USHORT", value: 0 }, { name: "entrySelector", type: "USHORT", value: 0 }, { name: "rangeShift", type: "USHORT", value: 0 }]);
      ...
      return t.sort(function(e2, a2) {
        return e2.value.tag > a2.value.tag ? 1 : -1;
    ...
    function fontToSfntTable(e) {
      ...
      var w = [], B = _name.make(W, w), U = w.length > 0 ? ltag.make(w) : void 0, L = post.make(), A = cff.make(e.glyphs, { version: e.getEnglishName("version"), fullName: E, familyName: C, weightName: N, postScriptName: O, unitsPerEm: e.unitsPerEm, fontBBox: [0, x.yMin, x.ascender, x.advanceWidthMax] }), F = e.metas && Object.keys(e.metas).length > 0 ? meta.make(e.metas) : void 0, G = [b, M, S, T, B, R, L, A, k];
      U && G.push(U), e.tables.gsub && G.push(gsub.make(e.tables.gsub)), F && G.push(F);
      var D = makeSfntTable(G), H = D.encode(), P = computeCheckSum(H), I = D.fields, j = false;
      for (g = 0; g < I.length; g += 1)
        if ("head table" === I[g].name) {
          I[g].value.checkSumAdjustment = 2981146554 - P, j = true;
          break;
        }
      if (!j)
    ...
    var check = require2("../check"), table = require2("../table"), cmap = require2("./cmap"), cff = require2("./cff"), head = require2("./head"), hhea = require2("./hhea"), hmtx = require2("./hmtx"), ltag = require2("./ltag"), maxp = require2("./maxp"), _name = require2("./name"), os2 = require2("./os2"), post = require2("./post"), gsub = require2("./gsub"), meta = require2("./meta");
    exports3.computeCheckSum = computeCheckSum, exports3.make = makeSfntTable, exports3.fontToTable = fontToSfntTable;
  }, { "../check": 2, "../table": 13, "./cff": 14, "./cmap": 15, "./gsub": 19, "./head": 20, "./hhea": 21, "./hmtx": 22, "./ltag": 25, "./maxp": 26, "./meta": 27, "./name": 28, "./os2": 29, "./post": 30 }], 32: [function(require2, module3, exports3) {
    "use strict";
    function constant(e) {
      return function() {
        return e;
    ...
    var check = require2("./check"), LIMIT16 = 32768, LIMIT32 = 2147483648, decode = {}, encode = {}, sizeOf = {};
    encode.BYTE = function(e) {
      ...
      var n = e.toString(), t = /\.(\d*?)(?:9{5,20}|0{5,20})\d{0,2}(?:e(.+)|$)/.exec(n);
      if (t) {
    ...
    var macEncodingTableCache = "function" == typeof WeakMap && /* @__PURE__ */ new WeakMap(), macEncodingCacheKeys, getMacEncodingTable = function(e) {
    ...
    encode.MACSTRING = function(e, n) {
      ...
      if (0 === c.length)
        return [0, 0];
      var i = [], a = 1 + Math.floor(Math.log(t) / Math.log(2)) / 8 | 0, f = [void 0, encode.BYTE, encode.USHORT, encode.UINT24, encode.ULONG][a];
    ...
    var wmm = "function" == typeof WeakMap && /* @__PURE__ */ new WeakMap();
    encode.CHARSTRING = function(e) {
      ...
      return e.length;
    }, exports3.decode = decode, exports3.encode = encode, exports3.sizeOf = sizeOf;
  }, { "./check": 2 }], 33: [function(require2, module3, exports3) {
    "use strict";
    exports3.isBrowser = function() {
      return "undefined" != typeof window;
    }, exports3.isNode = function() {
      return "undefined" == typeof window;
    }, exports3.nodeBufferToArrayBuffer = function(r) {
      for (var e = new ArrayBuffer(r.length), n = new Uint8Array(e), t = 0; t < r.length; ++t)
        n[t] = r[t];
      return e;
    }, exports3.arrayBufferToNodeBuffer = function(r) {
      for (var e = new Buffer(r.byteLength), n = new Uint8Array(r), t = 0; t < e.length; ++t)
        e[t] = n[t];
      return e;
    }, exports3.checkArgument = function(r, e) {
      if (!r)
        throw e;
    };
  }, {}] }, {}, [9])(9);
